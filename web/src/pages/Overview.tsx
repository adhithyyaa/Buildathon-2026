  ...
  return (
    <div className="space-y-6">
      ...
      {impact && impact.series.length >= 2 ? (
        <Card
          title="Measured impact — with Overwatch vs without"
          right={
            <span className="flex items-center gap-4 text-[11px] font-semibold">
              ...
              <span className="flex items-center gap-1.5 text-slate-500"><span className="h-0 w-5 border-t-2 border-dashed border-slate-500" /> Without Overwatch (control-measured)</span>
            </span>
          }
        >
