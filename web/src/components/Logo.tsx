/**
 * The Sentinel AI brand mark — an emerald shield (guardianship / integrity) with a verified check.
...
export function Logo({ className = 'h-9 w-9' }: { className?: string }) {
  return (
    <svg viewBox="0 0 32 32" className={className} fill="none" role="img" aria-label="Sentinel AI">
      <path
